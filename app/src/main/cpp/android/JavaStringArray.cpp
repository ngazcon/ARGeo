...
#include "include/JavaStringArray.h"
...
JavaStringArray::JavaStringArray(JavaString **data, const std::size_t numElements, bool copyData) :
...
void JavaStringArray::set(JavaString **data, const std::size_t numElements, bool copyData) {
  if (data == NULL && numElements > 0) {
