...
ShortArray::ShortArray(short *data, const std::size_t numElements, bool copyData) :
...
void ShortArray::set(short *data, const std::size_t numElements, bool copyData) {
  if (data == NULL && numElements > 0) {
