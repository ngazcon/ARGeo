...
public:
   ...
   */
  ByteArray(void *data, const std::size_t numBytes, bool copyData);
   ...
   * described above.
   */
  void set(void *data, const std::size_t numBytes, bool copyData);
   ...
   */
  const std::size_t size() const { return _num_bytes; }
