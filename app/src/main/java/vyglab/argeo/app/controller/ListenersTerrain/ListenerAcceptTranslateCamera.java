...
public class ListenerAcceptTranslateCamera implements View.OnClickListener {
    private Activity m_activity;
    private MainActivityState m_main_activity_state;
    private ArgeoFragment m_argeoFragment;

    public ListenerAcceptTranslateCamera(Activity activity, MainActivityState activity_state, ArgeoFragment fragment){
        m_activity = activity;
    ...
    public void onClick(View v){
        //TODO Codigo para el translate camera
        Toast.makeText(m_activity.getApplicationContext(), "Camera Translation accepted!", Toast.LENGTH_SHORT).show();
