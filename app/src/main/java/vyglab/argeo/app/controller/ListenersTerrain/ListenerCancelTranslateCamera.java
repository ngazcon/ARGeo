...
public class ListenerCancelTranslateCamera implements View.OnClickListener {
    private Activity m_activity;
    private MainActivityState m_main_activity_state;
    private ArgeoFragment m_argeoFragment;

    public ListenerCancelTranslateCamera(Activity activity, MainActivityState activity_state, ArgeoFragment fragment){
        m_activity = activity;
    ...
    public void onClick(View v){
        ...
        Toast.makeText(m_activity.getApplicationContext(), "Camera Translation canceled!", Toast.LENGTH_SHORT).show();
