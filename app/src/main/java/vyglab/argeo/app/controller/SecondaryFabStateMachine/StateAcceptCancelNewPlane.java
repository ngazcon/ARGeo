...
public class StateAcceptCancelNewPlane extends SecondaryFabState {

    public StateAcceptCancelNewPlane(FloatingActionButton fab_first, FloatingActionButton fab_Second,
