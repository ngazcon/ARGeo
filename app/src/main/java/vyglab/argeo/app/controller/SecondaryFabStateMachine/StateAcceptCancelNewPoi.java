 ...
 */
public class StateAcceptCancelNewPoi extends SecondaryFabState {

    public StateAcceptCancelNewPoi(FloatingActionButton fab_first, FloatingActionButton fab_Second,
