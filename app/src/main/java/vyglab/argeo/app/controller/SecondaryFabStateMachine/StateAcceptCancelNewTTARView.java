...
public class StateAcceptCancelNewTTARView  extends SecondaryFabState {

    public StateAcceptCancelNewTTARView(FloatingActionButton fab_first, FloatingActionButton fab_Second,
