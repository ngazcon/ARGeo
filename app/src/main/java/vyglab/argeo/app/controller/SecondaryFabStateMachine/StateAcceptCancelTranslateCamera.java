...
public class StateAcceptCancelTranslateCamera extends SecondaryFabState {

    public StateAcceptCancelTranslateCamera(FloatingActionButton fab_first, FloatingActionButton fab_Second,
