...
public class StatePoiEdit extends SecondaryFabState {

    public StatePoiEdit(FloatingActionButton fab_first, FloatingActionButton fab_Second,
    ...
    public void handle(){
        ...
        m_fab_first.setImageResource(R.drawable.ic_menu_pencil);
        m_fab_second.setImageResource(R.drawable.ic_menu_cancel_outline);
