...
public class StatePoiNew extends SecondaryFabState {

    public StatePoiNew(FloatingActionButton fab_first, FloatingActionButton fab_Second,
    ...
    public void handle(){
        ...
        m_fab_first.setImageResource(R.drawable.ic_menu_map_marker_plus);
