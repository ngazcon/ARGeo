...
public class StateTerrain extends SecondaryFabState {

    public StateTerrain(FloatingActionButton fab_first, FloatingActionButton fab_Second,
    ...
    public void handle(){
        ...
        m_fab_first.setImageResource(R.drawable.ic_menu_translation);
        m_fab_second.setImageResource(R.drawable.ic_menu_rotate_3d);
