...
public class StateTTARViewSelection extends SecondaryFabState {

    public StateTTARViewSelection(FloatingActionButton fab_first, FloatingActionButton fab_Second)
    {
    ...
    public void handle(){
        ...
        m_fab_second.setOnClickListener(m_listeners.get(Transitions.SECONDARY_FAB_2));

        m_fab_first.setImageResource(R.drawable.ic_menu_photo_size_select_large);
        m_fab_second.setImageResource(R.drawable.ic_menu_pencil);
