...
public class StateTTARViewSketch extends SecondaryFabState {

    public StateTTARViewSketch(FloatingActionButton fab_first, FloatingActionButton fab_Second)
    {
    ...
    public void handle(){
        ...
        m_fab_first.setImageResource(R.drawable.ic_menu_accept_outline);
        m_fab_second.setImageResource(R.drawable.ic_menu_tune);
